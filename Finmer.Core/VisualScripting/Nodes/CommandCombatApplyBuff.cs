    ...
    public sealed class CommandCombatApplyBuff : ScriptCommand
    {
        ...
        public override string GetEditorDescription(IContentStore content)
        {
            ...
            return Target == ETarget.Player
                ? $"Apply Buff '{buff_text}' to Player for {Duration} round(s)"
                : $"Apply Buff '{buff_text}' to NPC {ParticipantID} for {Duration} round(s)";
        }
        ...
        public override void Serialize(IFurballContentWriter outstream)
        {
            ...
            outstream.WriteObjectProperty(nameof(Effect), Effect, EFurballObjectMode.Optional);
        ...
        public override void Deserialize(IFurballContentReader instream)
        {
            ...
            Effect = instream.ReadObjectProperty<Buff>(nameof(Effect), EFurballObjectMode.Optional);
