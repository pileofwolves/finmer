...
namespace Finmer.Editor
{
    ...
    /// <summary>
    /// Custom color table for the editor window. This fixes a few ugly/inconsistent color choices, particularly regarding the
    /// button separators and the tooltip background colors.
    /// </summary>
    internal class RibbonColorTableCustom : RibbonProfesionalRendererColorTable
    {

        internal RibbonColorTableCustom()
        {
            ...
            PanelBorder_2013 = FromHex("#C5C5C5");
